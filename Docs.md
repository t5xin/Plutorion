...
## Booting the Library
```lua
local OrionLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/t5xin/Plutorion/refs/heads/main/library.lua')))()
```
...
## Creating a Window
```lua
local Window = OrionLib:MakeWindow({Name = "Pluto", HidePremium = false, SaveConfig = true, ConfigFolder = "Pluto"})
